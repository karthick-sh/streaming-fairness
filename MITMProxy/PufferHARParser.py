...
class PufferHARParser:
    ...
    def getMediaRequests(self):
        ...
        for entry in currentHAR:
            ...
            if 'video' in entry['response']['content']['mimeType']:
    ...
    def parseMediaRequests(self, media_requests):
        ...
        for index, media_request in enumerate(media_requests):
            ...
            print(index, parsed_entry["n_segment"], parsed_entry["body_size_byte"], parsed_entry["timestamp_start"])
            parsed_requests.append(entry)
    
        return parsed_requests

if __name__ == "__main__":
    parser = PufferHARParser("./Data/ReverseEngineering/mpc/report.2010-09-21_0742CEST.log_Norway_3/proxy_har.har")
